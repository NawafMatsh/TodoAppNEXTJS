      ...
      <div className="h-screen w-screen flex justify-center items-center absolute bg-black/50">
        ...
        >
          <div>
            ...
            <p className="text-[11px] mt-1">لايمكن استرجاع المحذوفات لاحقاً</p>
          </div>

          <div className="flex justify-center items-end">
            <button
              onClick={deleteFunc}
              className="bg-amber-400 rounded-md w-20 p-1 border ml-3 hover:scale-110"
            >
              حذف
            </button>
            <button
              onClick={closeFunc}
              className="rounded-md w-20 p-1 border hover:scale-110"
            >
              إغلاق
            </button>
          </div>
